...
--
-- Mine
SELECT owners.id FULL OUTER JOIN vehicles.owner_id COUNT(*) WHERE owners.id = vehicle.owner_id GROUP BY first_name, last_name;
...
-- 3
-- Mine
SELECT first_name, last_name, COUNT(owner_id) FROM owners o JOIN vehicles v ON o.id =v.owner_id AVG(price) GROUP BY first_name;
